...
public class Spawnfireleft : MonoBehaviour
{
    ...
    private Firesummonleft fireSummon;
    private float shootVel;
    private AudioSource fireAud;
    private float t;
    void Start()
    {
        fireSummon = FindObjectOfType<Firesummonleft>();
        upScale = 0.2f;
        fireHand_ = GameObject.FindGameObjectWithTag("FireHandLeft");
